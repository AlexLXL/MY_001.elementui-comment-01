  ...
  export default {
    ...
    data() {
      return {
        ...
        inputPattern: null, // 输入框的校验表达式,正则
        inputValidator: null,   // 输入框校验未通过时的提示文本
        inputErrorMessage: '',
        showConfirmButton: true,    // 确定按钮是否显示
        showCancelButton: false,    // 取消按钮是否显示
        action: '',
        confirmButtonText: '',  // 确定按钮的文本内容
        cancelButtonText: '',   // 取消按钮的文本内容
        confirmButtonLoading: false,    // 内部option，确认按钮的loading(2.14.0取消了该属性)
        cancelButtonLoading: false,     // 内部option，取消按钮的loading(2.14.0取消了该属性)
        confirmButtonClass: '', // 确定按钮的自定义类名
        confirmButtonDisabled: false,
        cancelButtonClass: '',  // 取消按钮的自定义类名
        editorErrorMessage: null,
        callback: null, // 若不使用 Promise，可以使用此参数指定 MessageBox 关闭后的回调；
        dangerouslyUseHTMLString: false,    // 是否支持html片段
